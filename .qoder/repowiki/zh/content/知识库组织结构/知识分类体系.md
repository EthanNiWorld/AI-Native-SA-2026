...
## 更新摘要
**变更内容**
- 修正AI应用路径命名约定：从`ai-app`更新为`ai-application`
- 更新最后更新时间为2026-05-27
- 修复相关文件中的内部链接路径
...
- [Harness（缰绳）:1-193](file://knowledge/ai-general-notes/harness.md#L1-L193)
...
### "点"层级：单产品知识
- 组织原则：以厂商为单位，覆盖 MaaS、AI Coding、AI Application、AI Platform、AI Infra 等维度
- 内容构成：产品定位、能力矩阵、适用/不适用场景、关键技术论文、厂商实现差异、变更记录
- 适用场景：产品介绍、销售支持、技术对接、竞品分析
- 选型价值：提供"可检索、可对比"的产品能力视图，支撑快速决策

**章节来源**
- [index.md:20-78](file://index.md#L20-L78)
...
**章节来源**
- [index.md:57-63](file://index.md#L57-L63)
...
**章节来源**
- [index.md:64-70](file://index.md#L64-L70)
...
**更新** 修正了AI应用路径命名约定，将所有`ai-app`更新为`ai-application`，并更新了最后更新时间为2026-05-27